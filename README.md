...
# 📖 Hello Rails (Fron End) <a name="about-project"></a>

> Learn mor about this project below:

**Hello Rails (Fron-End)** is a simple Client for [Hello Rails API (Back-End)](https://github.com/Diegogagan2587/hello-rails-back-end) that fetch and display 10 different randomly greetings, retrieved from the DB in a JSON format using the endpoint `/greetings`
...
<details>
  ...
  <ul>
    ...
    <li><a href="https://github.com/Diegogagan2587/hello-rails-back-end">Hello-rails-back-end</a></li>
  </ul>
</details>
...
Feel free to check the [issues page](https://github.com/Diegogagan2587/hello-react-front-end/issues).
